...
complete -c xcodebuild -o target -d 'NAME                                             build the target NAME'
complete -c xcodebuild -o alltargets -d 'build all targets'
complete -c xcodebuild -o workspace -d 'NAME                                          build the workspace NAME'
complete -c xcodebuild -o scheme -d 'NAME                                             build the scheme NAME'
complete -c xcodebuild -o configuration -d 'NAME                                      use the build configuration NAME for building each target'
...
complete -c xcodebuild -o maximum-concurrent-test-oimulator-destinations -d 'NUMBER   the maximum number of simulator destinations to test on concurrently'
complete -c xcodebuild -o parallel-testing-enabled -d 'YES|NO                         overrides the per-target setting in the scheme'
...
complete -c xcodebuild -o enableAddressSanitizer -d 'YES|NO                           turn the address sanitizer on or off'
complete -c xcodebuild -o enableThreadSanitizer -d 'YES|NO                            turn the thread sanitizer on or off'
complete -c xcodebuild -o enableUndefinedBehaviorSanitizer -d 'YES|NO                 turn the undefined behavior sanitizer on or off'
...
complete -c xcodebuild -o enableCodeCoverage -d 'YES|NO                               turn code coverage on or off when testing'
...
complete -c xcodebuild -o enablePerformanceTestsDiagnostics -d 'YES|NO                enables performance trace and memgraph collection for performance XCTests'
...
complete -c xcodebuild -o test-timeouts-enabled -d 'YES|NO                            enable or disable test timeout behavior'
...
complete -c xcodebuild -o test-repetition-relaunch-enabled -d 'YES|NO                 Enable or disable, tests repeating in a new process for each repetition.  Must be used in conjunction with -test-iterations, -retry-tests-on-failure, or -run-tests-until-failure. If not specified, tests will repeat in the same process.'
