...
complete -c sd -s f -l flags -x -a 'c\tcase-sensitive e\tdisable\ multi-line\ matching i\tcase-insensitive m\tmulti-line\ matching s\tmake\ .\ match\ newlines w\tmatch\ full\ words\ only' -d 'Regex flags. May be combined (like `-f mc`).' -r
