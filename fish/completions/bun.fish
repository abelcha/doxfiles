...
complete -c "bun" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # global
complete -c "bun" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # global
...
complete -c "bun" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # global
...
complete -c "bun" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # global
...
complete -f -c "bun" -n "__fish_use_subcommand" -a "run" -d "Execute a file with Bun or run a package.json script" # sub
...
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "unhandled-rejections" -d "One of \"strict\", \"throw\", \"warn\", \"none\", or \"warn-with-error-code\"" -xa "strict throw warn none warn-with-error-code" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'x'" -l "shell" -d "Control the shell used for package.json scripts. Supports either 'bun' or 'system'" -xa "bun system" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'exec'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'exec'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'exec'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'exec'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'install'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'install'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'install'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'install'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'audit'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'audit'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'audit'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'audit'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'link'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'link'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'link'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'link'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'publish'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'publish'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'publish'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'publish'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "unhandled-rejections" -d "One of \"strict\", \"throw\", \"warn\", \"none\", or \"warn-with-error-code\"" -xa "strict throw warn none warn-with-error-code" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'why'" -l "shell" -d "Control the shell used for package.json scripts. Supports either 'bun' or 'system'" -xa "bun system" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'init'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'init'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'init'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'init'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'create'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'create'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'create'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'create'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'upgrade'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'upgrade'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'upgrade'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'upgrade'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "cpu-prof-md" -d "Output CPU profile in markdown format (grep-friendly, designed for LLM analysis)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling (default: 1000)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "heap-prof-name" -d "Specify the name of the heap profile file" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "heap-prof-dir" -d "Specify the directory where the heap profile will be saved" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "heap-prof-md" -d "Generate markdown heap profile on exit (for CLI analysis)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "install" -d "Configure auto-install behavior. One of \"auto\" (default, auto-installs when no node_modules), \"fallback\" (missing packages only), \"force\" (always)." -xa "auto fallback force" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "dns-result-order" -d "Set the default order of DNS lookup results. Valid orders: verbatim (default), ipv4first, ipv6first" -xa "verbatim ipv4first ipv6first" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "unhandled-rejections" -d "One of \"strict\", \"throw\", \"warn\", \"none\", or \"warn-with-error-code\"" -xa "strict throw warn none warn-with-error-code" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "cron-title" -d "Title for cron execution mode" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "cron-period" -d "Cron period for cron execution mode" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "shell" -d "Control the shell used for package.json scripts. Supports either 'bun' or 'system'" -xa "bun system" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "parallel" -d "Run multiple scripts concurrently with Foreman-style output" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "sequential" -d "Run multiple scripts sequentially with Foreman-style output" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'feedback'" -l "no-exit-on-error" -d "Continue running other scripts when one fails (with --parallel/--sequential)" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'run'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "retry" -d "Default retry count for all tests, overridden by per-test { retry: N }" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "coverage-reporter" -d "Report coverage in 'text' and/or 'lcov'. Defaults to 'text'." # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'test'" -l "path-ignore-patterns" -d "Glob patterns for test file paths to ignore." # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "F" -l "filter" -d "Run a script in all workspace packages matching the pattern" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "elide-lines" -d "Number of lines of script output shown when using --filter" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "shell" -d "Control the shell used for package.json scripts" -xa "bun system" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "r" -l "preload" -d "Import a module before other modules are loaded" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "require" -d "Alias of --preload, for Node.js compatibility" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "import" -d "Alias of --preload, for Node.js compatibility" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "inspect" -d "Activate Bun's debugger" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "inspect-wait" -d "Activate Bun's debugger, wait for a connection before executing" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "inspect-brk" -d "Activate Bun's debugger, set breakpoint on first line of code and wait" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cpu-prof-name" -d "Specify the name of the CPU profile file" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cpu-prof-dir" -d "Specify the directory where the CPU profile will be saved" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cpu-prof-interval" -d "Specify the sampling interval in microseconds for CPU profiling" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "heap-prof" -d "Generate V8 heap snapshot on exit (.heapsnapshot)" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "heap-prof-name" -d "Specify the name of the heap profile file" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "heap-prof-dir" -d "Specify the directory where the heap profile will be saved" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "install" -d "Configure auto-install behavior" -xa "auto fallback force" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "e" -l "eval" -d "Evaluate argument as a script" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "p" -l "print" -d "Evaluate argument as a script and print the result" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "port" -d "Set the default port for Bun.serve" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "conditions" -d "Pass custom conditions to resolve" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "fetch-preconnect" -d "Preconnect to a URL while code is loading" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "max-http-header-size" -d "Set the maximum size of HTTP headers in bytes" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "dns-result-order" -d "Set the default order of DNS lookup results" -xa "verbatim ipv4first ipv6first" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "title" -d "Set the process title" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "unhandled-rejections" -d "One of \"strict\", \"throw\", \"warn\", \"none\", or \"warn-with-error-code\"" -xa "strict throw warn none warn-with-error-code" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "console-depth" -d "Set the default depth for console.log object inspection" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "user-agent" -d "Set the default User-Agent header for HTTP requests" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cron-title" -d "Title for cron execution mode" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cron-period" -d "Cron period for cron execution mode" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "main-fields" -d "Main fields to lookup in package.json" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "extension-order" -d "Defaults to: .tsx,.ts,.jsx,.js,.json" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "tsconfig-override" -d "Specify custom tsconfig.json" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "d" -l "define" -d "Substitute K:V while parsing, e.g. --define process.env.NODE_ENV:\"development\". Values are parsed as JSON." # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "drop" -d "Remove function calls, e.g. --drop=console removes all console.* calls." # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "feature" -d "Enable a feature flag for dead-code elimination, e.g. --feature=SUPER_SECRET" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "l" -l "loader" -d "Parse files with .ext:loader" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "jsx-factory" -d "Changes the function called when compiling JSX elements using the classic JSX runtime" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "jsx-fragment" -d "Changes the function called when compiling JSX fragments" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "jsx-import-source" -d "Declares the module specifier to be used for importing the jsx and jsxs factory functions" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "jsx-runtime" -d "\"automatic\" (default) or \"classic\"" -xa "automatic classic" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "env-file" -d "Load environment variables from the specified file(s)" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "no-env-file" -d "Disable automatic loading of .env files" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -l "cwd" -d "Absolute path to resolve files & entry points from. This just changes the process' cwd." # global
complete -c "bun" -n "__fish_seen_subcommand_from 'repl'" -s "c" -l "config" -d "Specify path to Bun config file" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'add'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'remove'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'update'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'outdated'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "backend" -d "Platform-specific optimizations for installing dependencies. Possible values: \"clonefile\" (default), \"hardlink\", \"symlink\", \"copyfile\"" -xa "clonefile hardlink symlink copyfile" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "linker" -d "Linker strategy (one of \"isolated\" or \"hoisted\")" -xa "isolated hoisted" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'unlink'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'patch'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "filename" -d "the name of the tarball" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "quiet" -d "only output the tarball filename" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -s "g" -d "print the global path to bin folder" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'pm'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm scan'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pack'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm bin'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm list'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm why'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm whoami'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm view'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm version'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm pkg'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-string'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm hash-print'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm cache'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm migrate'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm untrusted'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm trust'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "dry-run" -d "do everything except for writing the tarball to disk" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "destination" -d "the directory the tarball will be saved in" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "filename" -d "the name of the tarball" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "ignore-scripts" -d "don't run pre/postpack and prepare scripts" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "gzip-level" -d "specify a custom compression level for gzip (0-9, default is 9)" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "quiet" -d "only output the tarball filename" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -s "g" -d "print the global path to bin folder" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "all" -d "list the entire dependency tree according to the current lockfile" -xa "{}" # subcommands flags
complete -c "bun" -n "__fish_seen_subcommand_from 'pm default-trusted'" -l "all" -d "trust all untrusted dependencies" -xa "{}" # subcommands flags
...
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "omit" -d "Exclude 'dev', 'optional', or 'peer' dependencies from install" -xa "dev optional peer" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "cpu" -d "Override CPU architecture for optional dependencies (e.g., x64, arm64, * for all)" -xa "x64 arm64 *" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'info'" -l "os" -d "Override operating system for optional dependencies (e.g., linux, darwin, * for all)" -xa "linux darwin *" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "compile-executable-path" -d "Path to a Bun executable to use for cross-compilation instead of downloading" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "target" -d "The intended execution environment for the bundle. \"browser\", \"bun\" or \"node\"" -xa "browser bun node" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "metafile" -d "Write a JSON file with metadata about the build" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "metafile-md" -d "Write a markdown file with a visualization of the module graph (LLM-friendly)" # global
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "sourcemap" -d "Build with sourcemaps - 'linked', 'inline', 'external', or 'none'" -xa "linked inline external none" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "format" -d "Specifies the module format to build to. \"esm\", \"cjs\" and \"iife\" are supported. Defaults to \"esm\", or \"cjs\" with --bytecode." -xa "esm cjs iife" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "allow-unresolved" -d "Allow unresolved dynamic import()/require() specifiers matching these glob patterns. Use '<empty>' for opaque specifiers. Default is '*' (allow all)." # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'build'" -l "packages" -d "Add dependencies to bundle or keep them external. \"external\", \"bundle\" is supported. Defaults to \"bundle\"." -xa "external bundle" # global
...
complete -c "bun" -n "__fish_seen_subcommand_from 'init'" -l "react" -xa "{tailwind\\tInitialize a React project with TailwindCSS,shadcn\\tInitialize a React project with @shadcn/ui and TailwindCSS}" # global
