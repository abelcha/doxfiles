# source '/usr/local/share/fish/completions/jq.fish'
#'complete -c jq -d "Select min value"                                       -r -f -a "min"'

complete -c jq -d "Select objects where .active == true" -r -f -a "(command cat /me/config/fish/completions/jq-examples.tsv)"
