...
complete -f -c defaults -n '__fish_seen_subcommand_from read read-type write rename delete export' -a '(__fish_defaults_domains)'
complete -f -c defaults -n '__fish_seen_subcommand_from read read-type write rename delete export' -o app
...
complete -f -c defaults -n __fish_use_subcommand -a export -d 'saves domain as a binary plist to path'
