...
complete -c chroma -l style -s s -x -a "$CHROMA_STYLES"
complete -c chroma -l lexer -s l -x -a "$CHROMA_LEXERS"
complete -c chroma -l formatter -s f -x -a "$CHROMA_FORMATTERS"
