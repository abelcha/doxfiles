...
complete -f -c "code" -n "__fish_use_subcommand" -a "tunnel" -d "Make the current machine accessible from vscode.dev or other machines through a secure tunnel" # sub
complete -f -c "code" -n "__fish_use_subcommand" -a "serve-web" -d "Run a server that displays the editor UI in browsers." # sub
