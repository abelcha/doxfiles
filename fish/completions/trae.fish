...
complete -f -c trae -n __fish_use_subcommand -a a -d 'new window.'
complete -f -c trae -n __fish_use_subcommand -a --disable-extension -d '<ext-id>            Disable the provided extension. This'
complete -f -c trae -n __fish_use_subcommand -a option -d 'is not persisted and is'
complete -f -c trae -n __fish_use_subcommand -a a -d 'new window.'
complete -f -c trae -n __fish_use_subcommand -a --sync -d '<on | off>                       Turn sync on or off.'
complete -f -c trae -n __fish_use_subcommand -a --inspect-extensions -d '<port>             Allow debugging and profiling of'
