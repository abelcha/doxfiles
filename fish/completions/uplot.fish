...
complete -c uplot -n "__fish_seen_subcommand_from lineplot" -l canvas -d "type of canvas" -xa "ascii block braille density dot"
...
complete -c uplot -n "__fish_seen_subcommand_from lineplots" -l fmt -d "xyxy : header is like ..." -xa "x1 y1 x2 y2 x3 y3"
...
complete -c uplot -n "__fish_seen_subcommand_from lineplots" -l canvas -d "type of canvas" -xa "ascii block braille density dot"
...
complete -c uplot -n "__fish_seen_subcommand_from scatter" -l fmt -d "xyxy : header is like ..." -xa "x1 y1 x2 y2 x3 y3"
...
complete -c uplot -n "__fish_seen_subcommand_from scatter" -l canvas -d "type of canvas" -xa "ascii block braille density dot"
...
complete -c uplot -n "__fish_seen_subcommand_from density" -l fmt -d "xyxy : header is like ..." -xa "x1 y1 x2 y2 x3 y3"
...
complete -c uplot -n "__fish_seen_subcommand_from density" -l canvas -d "type of canvas" -xa "ascii block braille density dot"
