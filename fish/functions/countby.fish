function countby
    ...
    from $argv[1] select $argv[2] , count[ @ ] as c (set -q _flag_where; and echo "HAVING";or echo "") $_flag_where GROUP BY $argv[2] order by $_flag_sort (set -q _flag_desc;and echo "DESC";or echo "ASC")
end
